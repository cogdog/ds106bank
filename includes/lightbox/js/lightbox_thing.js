		...
		afterLoad   : function() {
          ...
          // start building output
           ...
           // using visual editor?
			...
			if ($('#assignmentURL').val() != 'n/a') {
			  output += '<div class="col-sm-4" id="examplemedia"><strong>Example for "' + $('#assignmentTitle').val() + '"</strong><br /><a href="' + $('#assignmentURL').val() + '">' + $('#assignmentURL').val() + '</a><br />' + myEmbed + '</div>';
			}
