...
function wp_bootstrap_custom_admin_footer() {
	echo '<span id="footer-thankyou">DS106 Bank developed by <a href="http://cog.dog" target="_blank">@cogdog</a> based on original <a href="https://github.com/arnabwahid/wordpress-bootstrap" target="_blank">wp-bootstrap by 320press</a></span>.';
}
...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        // For child themes
        wp_register_style( 'wpbs-style', get_template_directory_uri() . '/style.css', array(), '1.0', 'all' );
