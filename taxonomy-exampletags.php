				...
				<div id="main" class="col-sm-10 clearfix" role="main">
					...
					<div class="page-header">
 						<h1 class="archive_title h2">
							...
							echo ds106bank_option( 'thingname' ) . ' Responses and ' . ds106bank_option('helpthingname') . 's ';
