				...
				<div id="main" class="col-sm-10 clearfix" role="main">
					...
					<div class="page-header">
 						<h1 class="archive_title h2">
					    	<span><?php _e('Featured ' . THINGNAME . ' Responses', "wpbootstrap"); ?> </span>
					    </h1>					</div>
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
						...
						<header>
							...
							<p class="meta"><?php _e("Added", "wpbootstrap"); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_date(); ?></time> <?php _e("by", "wpbootstrap"); ?> <?php echo get_post_meta($post->ID, 'syndication_source', $single = true);?>, response  for  <?php echo $assignment_str?> <?php echo THINGNAME?></p>
