			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="col-sm-8" role="main">
					...
					<div class="page-header">
						...
						<p>There <?php echo $verb?>  <strong><?php echo $found_things;?></strong>  <?php echo  $plural?> in this category. View sorted by <select name="goto" id="assignmentList" onchange="window.location.href= this.form.goto.options[this.form.goto.selectedIndex].value">
							<?php
